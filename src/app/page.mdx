...
- **Canvas**
  ...
  <CourseDataLink linkKey={courseData.offering.linkCanvas} outerComponent="p"/>

- **Ed Discussion**

  <CourseDataLink linkKey={courseData.offering.linkEdDiscussion} outerComponent="p"/>

- **Drive**

  <CourseDataLink linkKey={courseData.offering.linkDrive} outerComponent="p"/>

- **GitLab**

  <CourseDataLink linkKey={courseData.offering.linkGitLab} outerComponent="p"/>
...
<CourseDataLink linkKey={courseData.offering.linkCanvas}>Canvas</CourseDataLink>.
...
<CourseDataLink linkKey={courseData.offering.linkGitHub} outerComponent="p"/>
