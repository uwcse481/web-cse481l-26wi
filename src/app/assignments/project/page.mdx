...
Submit an initial poster for in-class feedback.
We then expect teams to be available and responsive via email for any additional feedback and rapid iteration to finalize the poster.

**Initial Poster Due:** {formatCalendarDate(calendarData.assignments.projectInitialPoster.date, "EEE MMM d")}, 8pm

**Final Poster Due:** {formatCalendarDate(calendarData.assignments.projectFinalPoster.date, "EEE MMM d")}, 8pm
